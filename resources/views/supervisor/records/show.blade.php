...
<div class="container">
    ...
    <form action="{{route('supervisor_records.update',$record->id)}}" method="post">
    @csrf
        <input type="hidden" name="_method" value="put">
        <label for="">Comment</label>
        <textarea class="form-control" name="comment" id="" cols="20" rows="5" placeholder="Drop Your Comment Here!"></textarea>
